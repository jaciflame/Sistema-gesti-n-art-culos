        ...
        <div class="p-4 border-2 border-black rounded-2xl shadow-2xl mx-auto w-1/2">
            <form action="{{route('contacto.procesar')}}" method="POST">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <button type="reset" class="bg-gray-300 text-gray-700 px-6 py-2 rounded-md hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-500">Resetear</button>
                </div>
            </form>
        </div>
    </x-self.base>
